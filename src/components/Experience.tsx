      ...
      <div className="relative space-y-8">
        ...
        <ScrollReveal>
          <div className="relative pl-10 group">
            ...
            <div className="bg-surface border border-border/20 rounded-lg p-5 lg:p-6 hover:border-primary/30 transition-colors">
              ...
              <ul className="space-y-2.5 text-[15px] leading-7 text-muted">
        ...
        <ScrollReveal delay={0.15}>
          <div className="relative pl-10 group">
            ...
            <div className="bg-surface border border-border/20 rounded-lg p-5 lg:p-6 hover:border-primary/50 transition-colors">
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                <div>
